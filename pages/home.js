            ...
            <div key={provider.name}>
			 ...
			 <main className="flex flex-col xl:flex-row max-w-screen-lg mx-auto">
                    <div className="space-y-6 xl:space-y-10">
                        <h1 className="text-3xl md:text-5xl text-amber-800/80 max-w-xl mx-auto !leading-snug pl-4 xl:pl-0">
                    ...
                    <div className="relative xl:absolute w-80 h-80 xl:w-[650px] xl:h-[650px] top-14 right-5 mx-auto">
